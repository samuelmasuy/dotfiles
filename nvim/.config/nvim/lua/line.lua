-- inspired from evil_lualine: https://gist.github.com/hoob3rt/b200435a765ca18f09f83580a606b878
...
local lsp = {
  ...
  condition = function() return #vim.lsp.get_active_clients() > 0 and vim.fn.winwidth(0) > 40 end,
}
