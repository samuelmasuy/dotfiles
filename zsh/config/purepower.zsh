...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{%(?.$(_pp_c 2 78).$(_pp_c 1 9))}$p%f "
  ...
  typeset -g POWERLEVEL9K_DIR_{HOME,HOME_SUBFOLDER,ETC,DEFAULT}_FOREGROUND=$(_pp_c 4 blue)
  ...
  # # typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$(_pp_c 2 78)
  ...
  # typeset -g POWERLEVEL9K_VCS_{CLEAN,UNTRACKED,MODIFIED,LOADING,ACTIONFORMAT}_FOREGROUND=$(_pp_c 3 242)

  # # typeset -g POWERLEVEL9K_VCS_DIRTY_ICON=$'\b'
  ...
  # typeset -g POWERLEVEL9K_VCS_{UNSTAGED,UNTRACKED}_ICON='✗'
  ...
  # Show previous command wall time only if it's >= 1s.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=1
  # Don't show fractional seconds.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=2
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=none
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$(_pp_c 5 yellow)
